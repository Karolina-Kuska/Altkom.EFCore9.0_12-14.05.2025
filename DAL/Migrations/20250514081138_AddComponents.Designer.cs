...
namespace DAL.Migrations
{
    ...
    [Migration("20250514081138_AddComponents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Components.Component", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Components.Status", b =>
                {
            ...
            modelBuilder.Entity("Models.Components.SubComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Components.SubComponent", b =>
                {
                    b.HasOne("Models.Components.Component", "Component")
                        .WithMany("SubComponents")
                        .HasForeignKey("ComponentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.Components.Status", "Status")
                        .WithMany()
